...
import { createCss, createConfig } from '@stitches/css'
...
const elementWrapper = (color: string = 'c1')  => css.compose(
...
const elementNumber = css.compose(
  css.position('absolute'),
  css.fontSize('4px'),
...
const elementSymbol = css.compose(
  css.position('absolute'),
  css.top('50%'),
  css.left(0),
  css.right(0),
...
const elementDetails = css.compose(
  css.position('absolute'),
  css.fontSize('4px'),
  css.color('rgba(255, 255, 255, 0.5)'),
  css.opacity(0),
...
const periodicTable = css.compose(
  css.position('relative'),
  css.height('200px'),
  css.marginRight('-1px'),
  css.textShadow('none'),
