...
const ElementWrapper: any = styled.div`
  ...
  background-color: ${(props: any) => colors[props.color] || colors.c1};
`;

const ElementNumber: any = styled.div`
  position: absolute;
  font-size: 4px;
...
const ElementSymbol: any = styled.div`
  position: absolute;
  top: 50%;
  left: 0px;
  right: 0px;
...
const ElementDetails: any = styled.div`
  position: absolute;
  font-size: 4px;
  color: rgba(255, 255, 255, 0.5);
  opacity: 0;
...
const PeriodicTable: any = styled.div`
  position: relative;
  height: 200px;
  margin-right: -1px;
  text-shadow: none;
...
const PeriodicRow: any = styled.div`
  clear: both;
  height: 10%;
`;
